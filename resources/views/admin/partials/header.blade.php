    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <div class="right-menu list-inline no-margin-bottom">    
          ...
          <!-- Tasks end-->
          <!-- Megamenu-->
          <div style="margin-right: 26px;" class="list-inline-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="nav-link">Mega <i class="fa fa-ellipsis-v"></i></a>
          ...
          <div class="list-inline-item logout">    
              ...
              <form id="logout-form" action="{{ route('logout') }}" method="POST">
                  @csrf
                  <button style="color: wheat" class="dropdown-item btn-danger pr-3 " type="submit">
                      Logout
                  </button>
              </form>
